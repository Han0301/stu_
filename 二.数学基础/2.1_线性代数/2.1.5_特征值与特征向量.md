...
**1. 本质理解** ⭐⭐
特征向量和特征值的几何含义是什么？为什么说特征向量是矩阵的"不変方向"？

**2. 概念辨析** ⭐
PCA 降维的本质是什么？为什么取最大的 k 个特征值对应的特征向量？

**3. 视觉关联** ⭐⭐
本质矩阵 E 的奇异值模式为什么是 `(σ, σ, 0)`？这告诉了我们关于 E 的什么性质？

**4. 代码实践** ⭐⭐⭐
手写 PCA 函数，输入数据矩阵 X(N,D)，输出前 2 个主方向、降维后的数据、以及各主成分的解释方差比。

**5. 原理追问** ⭐⭐
协方差矩阵为什么一定是对称的？对称矩阵的特征值和特征向量有什么特殊性质？
