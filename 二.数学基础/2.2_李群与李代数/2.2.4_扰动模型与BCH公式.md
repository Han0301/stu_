...
**1. 本质理解** ⭐⭐⭐
BCH 公式解决的是什么问题？为什么在 SO(3) 中"乘法 ≠ 加法"？

**2. 概念辨析** ⭐⭐
左乘扰动模型和右乘扰动模型有什么区别？在 BA 优化中通常使用哪一种？为什么？

**3. 代码实践** ⭐⭐⭐
手写 BA 中重投影误差对 se(3) 扰动的 Jacobian：`ba_jacobian(T, P, K)`。写出推导过程中的链式法则，以及每一步的维度。

**4. 视觉关联** ⭐⭐
在 BA 优化迭代中，增量 Δξ 是在 se(3) 中求得的。为什么不能直接在 SE(3) 上做加法 `T_new = T + ΔT`？
